...
object Premades {
  ...
  def apply(premadeController: PremadeController): RhoRoutes[IO] = {
    new RhoRoutes[IO] {

      "Endpoint to get premades in a game for a user" ** GET / "premades" / "by-summoner-name" /
      pathVar[String]("summonerName") +? param[String]("platform") & param[Int]("gameDepth", 5) &
      param[Boolean]("queryFriendly", false) |>>
