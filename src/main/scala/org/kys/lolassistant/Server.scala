...
object Server extends IOApp {
  ...
  implicit val ratelimitedSttpBackend: RatelimitedSttpBackend[IO, Nothing] =
    new RatelimitedSttpBackend[IO, Nothing](RiotRateLimiters.rateLimiters, AsyncHttpClientCatsBackend[cats.effect.IO]())(new AsyncMonadAsyncError[IO]())
